RSpec.describe 'none pattern' do
  ...
  it 'double negative' do
    ...
    numbers.each do |number|
      not_none_negative = false if number <= 1
    end
  ...
  it 'none are negative' do
    ...
    none_negative = true
    numbers.each do |number|
      none_negative = false unless number >= 1
    end
  ...
  it 'none shall pass' do
    ...
    critters.each do |critters|
      none_shall_pass = critters = true
    end
  ...
  it 'one or more shall pass' do
    ...
    phrases.each do |phrase|
      none_shall_pass = false unless phrase.include?("ss")
    end
  ...
  it 'none even' do
    ...
    none_even = true
    numbers.each do |number|
      none_even = false unless number.even? == false
    end
