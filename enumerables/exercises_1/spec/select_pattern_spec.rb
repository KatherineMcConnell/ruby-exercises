RSpec.describe 'select pattern' do
  ...
  it 'words ending in e' do
    ...
    selected = []
    words.each do |word|
      selected << word if word.end_with?("e") == true
    end
  ...
  it 'words ending in ing' do
    ...
    selected = []
    words.each do |word|
      selected << word if word.end_with?("ing") == true
    end
  ...
  it 'dinosaurs containing saurus' do
    dinos = ["tyrannosaurus", "narwhal", "eel", "achillesaurus", "qingxiusaurus"]
    dinosaurs = []
    dinos.each do |dino|
  ...
  it 'arrays' do
    ...
    elements.each do |elem|
      arrays << elem if elem.class == Array
    end
